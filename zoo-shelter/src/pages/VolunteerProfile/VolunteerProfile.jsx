...
const VolunteerProfile = () => {
  ...
  const volunteerData = {
    ...
    description: `Мене звати Іван, я волонтерю зі Львова. З перших днів повномасштабної війни моя місія — допомогати безпритульним тваринам шукати й для них омріяних домівок,
      ...
      <div className={styles.container}>
          ...
          <div className={styles.profileInfo}>
            ...
            <div className={styles.actionButtons}>
              <button className={styles.editButton} onClick={handleEditProfile}>
                {isMobile ? "Редагувати" : "Редагувати профіль"}
              </button>
              <button className={styles.doneButton}>
                Задонатити
              </button>
              <button className={styles.sendAnnouncementButton} onClick={handleCreateAnnouncement}>
                {isMobile ? "Створити" : "Створити оголошення"}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className={styles.otherAnimalsSection}>
          ...
          <div className={styles.otherAnimalsContainer}>
            {[1, 2, 3, 4].map((item) => (
                <AnimalCard key={item} className={styles.animalCard} onClick={() => navigate(`/animal/${item}`)} animalImageLink={animalImage} />
            ))}
          </div>
          {isMobile && 
            <button 
