...
import styles from './VolunteerProfileToSee.module.css';
import Header from '../../../components/Header/Header';
import AnimalCard from '../../../components/AnimalCard/AnimalCard';
import animalImage from '../../../assets/images/animal.png';
import profileImage from '../../../assets/images/image.png';

const VolunteerProfileToSee = () => {
          ...
          <div className={styles.profileInfo}>
            ...
            <div className={styles.actionButtons}>
              ...
              <button className={styles.giveAnimalButton} onClick={() => navigate('/send-announcment')}>
                <a href="/send-announcment">Передати тваринку</a>
              </button>
            </div>
          </div>
        </div>
...
export default VolunteerProfileToSee;