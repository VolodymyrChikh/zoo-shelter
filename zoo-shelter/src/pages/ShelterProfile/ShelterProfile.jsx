...
const ShelterProfile = () => {
  ...
  const volunteerData = {
    ...
    description: `Ми — притулок зі Львова, який з перших днів повномасштабної війни допомагає безпритульним тваринам знайти омріяні домівки, евакуйовує поранених із прифронтових територій та забезпечує кормами й медикаментами тих, хто цього найбільше потребує. За час нашої діяльності нам вдалося допомогти десяткам собак і котів знайти нові родини або потрапити до безпечного місця. Ми тісно співпрацюємо з волонтерами, благодійними організаціями, іншими притулками та ветеринарними клініками, щоб надавати тваринам максимальну підтримку й турботу.`
  };
